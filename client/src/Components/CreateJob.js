...
const CreateJob = () => {
  ...
  const submit = async (e) => {
    try {
      ...
      setDuration(0);
      setSpm(null);
      editSkillList([["C", "Python", "R", "Javascript", "Flutter", "Bash"]]);
      history.push("/rec/jobList");
    } catch (err) {
        ...
        <div className="form-group">
          <div>
            {skillsRequired.length ? (
              <div>
                <span className="lead mr-2">Required Skills: </span>
                ...
                <p className="text-center">(Click on above skills to remove)</p>
              </div>
            ) : (
              ...
              return (
                <a
                  ...
                  onClick={(e) => {
                    ...
                    const newSkills = [...skillsRequired, e.target.innerText];
                    setSkillsRequired(newSkills);
                  }}
                >
                  {skill}
